...
# Configuration
# The TLE API runs as a Docker service, so we use the service name for DNS resolution
# If running the API outside Docker, use 'http://host.docker.internal:5000'
