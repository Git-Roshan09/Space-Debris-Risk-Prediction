...
# Configuration
# The TLE API runs as a Docker service, accessed via the service name
TLE_API_BASE_URL = 'http://tle-api:5000' 
KAFKA_BOOTSTRAP_SERVERS = ['kafka:9093']  # Use internal Docker network listener
...
def parse_tle_elements(tle_line1, tle_line2):
    ...
    try:
        ...
        logger.warning(f"Error at parse_tle_elements: {e}")
        return {}
...
def get_api_stats():
    ...
    try:
        ...
        logger.error(f"Error at get_api_stats: {e}")
        return None
